...
class CustomOrderCardPending extends GetView<PendingControllerImp> {
  final int index;
  const CustomOrderCardPending( {super.key,required this.index});
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        if(controller.data[index].ordersStatus=="0")   ElevatedButton(
                            style: ButtonStyle(backgroundColor:MaterialStateProperty.all(Colors.red)),
                            onPressed: () {
                              controller.deleteOrder(controller.data[index].ordersId!);
                            },
